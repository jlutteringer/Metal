package org.metal.function.equality;
...
public class EqualityMapping<T> {
	...
	private Map<BiGroup<Object>, Pair<BiGroup<Object>, Equalitor<Object, Object>>> backingMap = Maps.newHashMap();
	...
	public boolean test(T first, T second) {
		...
		if (backingMap.containsKey(key)) {
			...
			Pair<BiGroup<Object>, Equalitor<Object, Object>> context = backingMap.get(key);
			BiGroup<Object> contextGroup = context.getFirst();

			Equalitor<Object, Object> test = context.getSecond();
			boolean result;
	...
	public <A extends T, B extends T> void addEquality(Class<A> firstType, Class<B> secondType, Equalitor<A, B> test) {
		BiGroup<Object> key = Groups.group(firstType, secondType);
		backingMap.put(key, _Tuple.of(key, (Equalitor<Object, Object>) test));
	}
}